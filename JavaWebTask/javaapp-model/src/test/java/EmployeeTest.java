...
public class EmployeeTest extends Assert {
    ...
    public void setUp() {
        ...
        listEmployee.add(new Employee(1,"Vasiya","Petrov","Minsk","SE","Java"));
        listEmployee.add(new Employee(2,"Petia","Orlov","Gomel","JSE","PHP"));
        listEmployee.add(new Employee(3,"Kolia","Drozdov","Vitebsk","SSE",".Net"));
    ...
    public void testEqualsEmployeesOperation(){
        Employee employee1 = new Employee(1,"Vasiya","Petrov","Minsk","SE","Java");
        Employee employee2 = new Employee(1,"Vasiya","Petrov","Minsk","SE","Java");
        assertTrue(employee1.equals(employee2));
    }

    @Test(expected = AssertionError.class)
    public void testAssertionErrorException(){
        Employee employee1 = new Employee(1,"Kolya","Petrov","Minsk","SE","Java");
        Employee employee2 = new Employee(1,"Vasiya","Petrov","Minsk","SE","Java");
        assertTrue(employee1.equals(employee2));
    }
